...
void setup()
{
  ...
  //drammar_phrase phrase = new drammar_phrase(aScreen, "Arialda", "Ma ciao!!!\na capo", 100, 2, null);  
  //drammar_phrase phrase2 = new drammar_phrase(aScreen, "Arialda", "Ma ciao!!!\na capo", 200, 2, null);  
  //drammar_phrase phrase3 = new drammar_phrase(aScreen, "Arialda", "Ma ciao!!!\na capo", 300, 2, /*new SoundFile(this, "sample.mp3")*/ null);
  
  //aScreen.AddPhrase(phrase);
  //aScreen.AddPhrase(phrase2);
  //aScreen.AddPhrase(phrase3);
