...
class HCluster {
  String id, type, print; // id, type (HCL), and long print
  ArrayList plans; 
  int rec_levels;
  color c = #000000;

  HCluster(String i, String t, String p) {
    id = i;
    type = t; 
    print = p;
    plans = new ArrayList(); 
  ...
  // compute the recursive sublayers and orders plans through increasing rec level
